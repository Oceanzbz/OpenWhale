...
def _load_config() -> dict[str, str]:
    ...
    optional_vars = {
        ...
        "MAX_CONCURRENT_CHALLENGES": os.getenv("MAX_CONCURRENT_CHALLENGES", "3"),
        "DEEPAGENTS_TIMEOUT_SECONDS": os.getenv("DEEPAGENTS_TIMEOUT_SECONDS", "600"),
        "DEEPAGENTS_REPEAT_CALL_LIMIT": os.getenv("DEEPAGENTS_REPEAT_CALL_LIMIT", "4"),
        "DEEPAGENTS_RECURSION_LIMIT": os.getenv("DEEPAGENTS_RECURSION_LIMIT", "128"),
        "DEEPAGENTS_BASH_TIMEOUT_SECONDS": os.getenv("DEEPAGENTS_BASH_TIMEOUT_SECONDS", "120"),
        "DEEPAGENTS_BASH_MAX_OUTPUT_CHARS": os.getenv("DEEPAGENTS_BASH_MAX_OUTPUT_CHARS", "12000"),
